...
<header>
    ...
    $categoryID = 5; // Assuming 5 is the ID for the "grocery" category
    ...
    <div class="col-md-3">
        <section class="panel">
            <div class="pro-img-box text-center">
                <span><img src="<?php echo $row['item_image']; ?>" alt="Item Image" 
                style="width: 230px; height: 200px; align-items-center"></span>
