		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Log In As PriceWiz Admin</h2>
				</div>
			</div>
			<div class="row justify-content-center">
					...
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form name="admin_login_page.html" method="POST" action="login_verify.php" class="signin-form">
